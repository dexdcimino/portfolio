...
| `node tools/work_check.mjs` | featured work, the work overlay, the code prompt, the games stack and the AI Lab, and the four thumbnails keeping a height at four widths either side of the one-column breakpoint — 106 checks, serves the repo itself |
