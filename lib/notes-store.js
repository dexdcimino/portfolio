...
const blobBackend = {
  async read(key) {
    ...
    try {
      ...
      // The SDK distinguishes "no such blob" from every other failure, and only
      // the first one means "nothing saved yet". Swallowing the rest would turn
      // an outage into a silent reset back to the seed.
