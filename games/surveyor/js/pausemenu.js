...
const CONTROLS = [
  ...
  ['Boost', ['Shift'], 'rover, boat and jet — sustained'],
  ['Jump', ['Space'], 'hold to charge, release to leap'],
  ['Drone: climb · descend', ['Shift', 'C'], 'the held height stays where you leave it'],
  ...
  ['Recentre the camera', ['C'], 'every form but the drone, where C descends'],
