/* ==========================================================================
   src/reset-progress.js — "Reset All Player Progress".

   MIRROR of games/_shared/reset-progress.js — keep the two in step.

   Stickland cannot import it. build.mjs refuses any specifier that escapes
   src/ ("only src-internal modules can be bundled") because it emits ONE
   self-contained file for itch.io and YouTube Playables, and a module living
   two directories up would not be in it. That is a deliberate property of the
   build, not an oversight, so this is a copy rather than a fix — the same
   arrangement the 7-accent palette already lives under across five files.

   Everything below this header is the shared file verbatim. Change one, change
   the other.
   ==========================================================================
